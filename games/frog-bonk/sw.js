// frog-bonk — installable PWA + offline via the shared sw-core (stale-while-revalidate, versioned cache).
self.SCOPE = 'frog-bonk';
self.VERSION = 'dev'; // stamped with the commit SHA at deploy
// SHELL = HTML + icons + the shared head files + EVERY i18n.<code>.js locale file (keep the
// locale list in lockstep with KOMYO_I18N_AVAILABLE in i18n.js / games/breakout/sw.js).
