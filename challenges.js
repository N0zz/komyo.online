...
window.CHALLENGES.goodRun = {
  ...
  forcefield: 500, 'frog-bonk': 2000, sudoku: 1500, minesweeper: 118, '2048': 4500,
};
...
window.CHALLENGES.playable = [
  ...
  'breakout', 'sudoku', 'stacker', 'flappy', 'aim-trainer', 'snake', '2048', 'minesweeper',
];
window.CHALLENGES.playableSince = {
  ...
  minesweeper: '2026-07-11', '2048': '2026-07-12',
};
